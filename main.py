...
class TaskPopup(Popup):
    ...
    def _refresh(self):
        ...
        for idx, task in enumerate(TASKS):
            ...
            del_btn = Button(text="Del", size_hint_x=None, width=40,
...
class TaskDetailPopup(Popup):
    ...
    def _refresh_grid(self):
        ...
        for idx, av in enumerate(items):
            ...
            av_name = trim_name(av.get("name") or "No Name")
    ...
    def _open_item_menu(self, idx):
        ...
        note_btn   = Button(text="Edit Note", background_color=(0.55, 0.5, 0.15, 1))
